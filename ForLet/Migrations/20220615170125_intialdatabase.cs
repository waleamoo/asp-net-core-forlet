        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RentalDescription = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RentalAddress = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    NoOfApartment = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Rent = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Agreement = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Rentals_Lgas_LgaId",
                        column: x => x.LgaId,
                        principalTable: "Lgas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Rentals_PropertyTypes_PropertyTypeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Rentals_LgaId",
                table: "Rentals",
                column: "LgaId");

            migrationBuilder.CreateIndex(
                name: "IX_Rentals_PropertyTypeId",
                table: "Rentals",
